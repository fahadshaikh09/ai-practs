...
Nodes created :  [1, 2, 3, 4, 5, 6, 7, 8, 9]
...
Edge  (3, 9, 5) Added
>>> edges
[(1, 2, None), (1, 3, None), (2, 4, 2), (2, 5, 1), (2, 6, 3), (3, 7, 4), (3, 8, 1), (3, 9, 5)]
>>> nodes
[1, 2, 3, 4, 5, 6, 7, 8, 9]
>>> end
Invalid Command! name 'end' is not defined
>>> 'end'
min palyed, foud minimum value nodes  [5, 8]
Max palyed, foud maximum value nodes  [3]
